...
void print_process(Process *proc) {
  ...
  printf("Name: %s", proc->name);
  printf("State: %s", state_to_string(proc->state));
  printf("PC Instruction: %d", proc->pc.last_instruction);
  printf("PC Page: %d", proc->pc.last_page);
  printf("Priority: %d", proc->priority);
  printf("RW Counter: %d", proc->counter_rw);
  printf("Segment ID: %d, Size: %d", proc->segment_id, proc->segment_size);
  printf("Runtime: %d", proc->runtime_execution);
  printf("Semaphores: %s", proc->semaphores);
  printf("Time-Slice: %d", proc->slice_time);
