...
//     WINDOW *janela_menu, *janela_OUTPUT, *janela_I_O, *janela_memory,
//     *janela_process, *janela_SCHEDULER;

//      char **displayP,**displayS,**displayI,**displayU,**displayM;
//     displayP =
//     init_string_array(displayP,DEF_WIN_MAX_PRINTS_BIG,MAX_OUTPUT_STR); displayS
//     = init_string_array(displayS, DEF_WIN_MAX_PRINTS_BIGGER,MAX_OUTPUT_STR);
//     displayI = init_string_array(displayI,
//     DEF_WIN_MAX_PRINTS_BIG,MAX_OUTPUT_STR); displayU =
//     init_string_array(displayU, DEF_WIN_MAX_PRINTS_SMALL,MAX_OUTPUT_STR);a
//     displayM = init_string_array(displayM,
//     DEF_WIN_MAX_PRINTS_BIG,MAX_OUTPUT_STR); int *sizes =
//     init_int_array(sizes,NUMBER_OF_WINDOWS);
//    */
...
//       //* NOTE - commented the prints from the functions for testing with the
//       //interface
...
//       } else {
//         Process *p1 = create_process_from_program(prog1);
//         print_win_args(janela_process,
//                        "PID: %d, Name: %s, Priority: %d, Segment_id: %d, PC: "
//                        "%d, STATE: %d",
//                        p1->pid, p1->name, p1->priority, p1->segment_id, p1->pc,
//                        p1->state);
//       }
//     };
